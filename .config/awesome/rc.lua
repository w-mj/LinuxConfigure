...
net_wired = net_widgets.indicator({
	    	interfaces  = {"enp4s0", "another_interface", "and_another_one"},
		    timeout     = 5,
			font		= "Source Code Pro"
		})
net_internet = net_widgets.internet({indent = 0, timeout = 5, font="Source Code Pro"})
...
-- beautiful.init(string.format("%s/.config/awesome/themes/%s/theme-personal.lua", os.getenv("HOME"), powerarrow))
...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
		...
		local wallpaper = "/home/wmj/Pictures/374852.jpg"
